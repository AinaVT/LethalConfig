...
namespace LethalConfig.ConfigItems
{
    public abstract class BaseConfigItem
    {
        ...
        internal string Section => Options.Section ?? BaseConfigEntry?.Definition.Section ?? "";
        internal string Name => Options.Name ?? BaseConfigEntry?.Definition.Key ?? "";
        internal string Description => Options.Description ?? BaseConfigEntry.Description.Description ?? "";
